  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', paddingBottom: 'var(--space-8)' }}>
      ...
      <div className="lesson-body">
        ...
        <section className="lesson-section">
          <h3>⚠️ 9. MFA no significa invulnerable</h3>
          ...
          <ConceptBadge>🛡️ MFA agrega una capa adicional de protección.</ConceptBadge>
        </section>
        ...
        <section className="lesson-section">
          <h3>🗝️ 13. Ahora aparece otro tipo de credencial</h3>
        ...
        <section className="lesson-section">
          ...
          <CompareCols cols={[
            { emoji: '🚪', title: 'Tarjeta A', items: ['Solo abre: habitación 302.', '⚠️ Problema importante, pero limitado.'] },
            { emoji: '🔑', title: 'Tarjeta B', items: ['Abre: todas las habitaciones, caja fuerte, administración, instalaciones.', '🚨 Problema mucho mayor.'] },
          ]} />
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[
            ...
            { emoji: '🔑', label: 'Access Key', caption: 'guardada en código' },
            { emoji: '📦', label: 'S3' },
          ]} />
          <Nota>
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[
            { emoji: '👥', label: 'Camila, Pedro, Daniela, Carlos' },
            { emoji: '👤', label: 'usuario-compartido' },
            { emoji: '🔑', label: 'misma contraseña' },
          ]} />
        ...
        <section className="lesson-section">
          <h3>🕵️ 28. Caso: correo sospechoso</h3>
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[
            { emoji: '🚨', label: 'Detecto exposición' },
            { emoji: '🔒', label: 'Deshabilitar/revocar credencial' },
            { emoji: '🔍', label: 'Revisar actividad' },
            { emoji: '🛠️', label: 'Corregir origen' },
            { emoji: '🔑', label: 'Crear reemplazo solo si es necesario' },
          ]} />
        </section>
        ...
        <div className="bridge-callout">
          ...
          <Flow steps={[
            { emoji: '🔐', label: 'IAM' },
            { emoji: '👤', label: 'Identidades · 🎭 Roles · 📜 Políticas' },
