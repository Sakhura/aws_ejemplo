  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', paddingBottom: 'var(--space-8)' }}>
      ...
      <div className="lesson-body">
        ...
        <section className="lesson-section">
          <h3>10. Volvamos a nuestro servidor</h3>
          <Flow steps={[
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[
            { icon: 'users', label: 'RolLecturaS3' },
            { icon: 'file-text', label: 'Política' },
            { icon: 'check-circle', label: 'Leer objetos S3' },
          ]} />
        ...
        <section className="lesson-section">
          <h3>17. Caso práctico: EC2 necesita S3</h3>
          <Nota><p>Tenemos una aplicación en EC2. Necesita leer imágenes almacenadas en S3.</p></Nota>
          <Flow steps={[
            { icon: 'server', label: 'EC2' },
            { icon: 'users', label: 'RolLecturaS3', caption: 'asume' },
            { icon: 'file-text', label: 'Puede leer' },
            { icon: 'package', label: 'S3' },
          ]} />
        ...
        <section className="lesson-section">
          <h3>18. ¿Por qué esto es mejor?</h3>
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[
            { icon: 'user', label: 'Carolina — Normal', caption: 'Permisos habituales' },
            { icon: 'users', label: 'Durante auditoría', caption: 'RolAuditoria — Permisos temporales' },
            { icon: 'user', label: 'Después', caption: 'Permisos habituales' },
          ]} />
        </section>
        ...
        <section className="lesson-section">
          ...
          <Nota><p>Caso:</p></Nota>
          <Flow steps={[
            { icon: 'server', label: 'Aplicación EC2' },
            { icon: 'key', label: 'Usuario IAM', caption: 'Access Key guardada en código' },
            { icon: 'package', label: 'S3' },
          ]} />
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[
            { icon: 'users', label: 'Confianza', caption: 'EC2 puede asumirlo' },
            { icon: 'users', label: 'RolLecturaS3' },
            { icon: 'file-text', label: 'Permisos', caption: 'Leer determinados objetos S3' },
          ]} />
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[
            { icon: 'user', label: 'QUIÉN NECESITA ACCESO' },
            { icon: 'users', label: 'CONFIANZA', caption: '¿Puede asumirlo?' },
            { icon: 'users', label: 'ROL' },
            { icon: 'file-text', label: 'POLÍTICA', caption: '¿Qué puede hacer?' },
            { icon: 'cloud', label: 'RECURSO AWS' },
          ]} />
        </section>
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[
            ...
            { icon: 'users', label: 'RolCertificados' },
            { icon: 'file-text', label: 'Leer plantillas' },
            { icon: 'package', label: 'S3' },
          ]} />
        </section>
        ...
        <section className="lesson-section">
          ...
          <Reveal label="Ver solución esperada">
            <Flow steps={[
              { icon: 'server', label: 'EC2' },
              { icon: 'users', label: 'RolLecturaFotos' },
              { icon: 'file-text', label: 'Permitir lectura' },
              { icon: 'package', label: 'S3 FotosProductos' },
            ]} />
        ...
        <section className="lesson-section">
          ...
          <CompareCols cols={[
            { icon: 'key', title: 'Solución A', items: ['EC2 → Access Key escrita en código'] },
            { icon: 'users', title: 'Solución B', items: ['EC2 → IAM Role'] },
          ]} />
          <QaItem
        ...
        <div className="bridge-callout">
          ...
          <ConceptBadge>Módulo 2 · Clase 5 — Credenciales, contraseñas, MFA y buenas prácticas de seguridad</ConceptBadge>
