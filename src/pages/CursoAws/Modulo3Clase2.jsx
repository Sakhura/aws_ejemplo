    ...
    <div style={{ display: 'flex', flexDirection: 'column', paddingBottom: 'var(--space-8)' }}>
      ...
      <div className="lesson-body">
        ...
        <section className="lesson-section">
          ...
          <RoleGrid roles={[
            { emoji: '💻', label: 'Equipo A', desc: 'Procesador básico · 4 GB RAM · 128 GB' },
            { emoji: '🖥️', label: 'Equipo B', desc: 'Procesador medio · 16 GB RAM · 512 GB' },
            { emoji: '🚀', label: 'Equipo C', desc: 'Procesador potente · 64 GB RAM · 2 TB' },
          ]} />
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[
            { emoji: '❓', label: 'Quiero crear EC2' },
            { emoji: '📀', label: 'AMI', caption: '¿Qué plantilla?' },
            { emoji: '⚙️', label: 'Tipo de instancia', caption: '¿Cuánta capacidad?' },
          ]} />
        </section>
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[{ emoji: '📖', label: 'Receta' }, { emoji: '🎂', label: 'Pastel' }]} />
          <p>En EC2:</p>
          <Flow steps={[{ emoji: '📀', label: 'AMI' }, { emoji: '🖥️', label: 'Instancia' }]} />
        ...
        <section className="lesson-section">
          <h3>⚠️ 11. AMI no significa exactamente "sistema operativo"</h3>
          <Nota>
        ...
        <section className="lesson-section">
          <h3>⚙️ 15. Segunda gran decisión: tipo de instancia</h3>
        ...
        <section className="lesson-section">
          ...
          <CompareCols cols={[
            { emoji: '🧮', title: 'RAM', items: ['Memoria de trabajo temporal.', 'Aplicaciones trabajando ahora'] },
            { emoji: '💾', title: 'Almacenamiento', items: ['Conserva información.', 'Archivos guardados'] },
          ]} />
        </section>

        <section className="lesson-section">
          <h3>🛏️ 20. Analogía del escritorio y el archivador</h3>
          <CompareCols cols={[
            { emoji: '🧮', title: 'RAM — El escritorio', items: ['Tenemos sobre él: 📄 documentos que estamos utilizando.'] },
            { emoji: '💾', title: 'Almacenamiento — El archivador', items: ['Guardamos: 📁 documentos para utilizarlos posteriormente.'] },
          ]} />
        ...
        <section className="lesson-section">
          ...
          <RoleGrid roles={[
            ...
            { emoji: '🧠', label: 'Cómputo', desc: '' },
            { emoji: '🧮', label: 'Memoria', desc: '' },
            { emoji: '💾', label: 'Almacen.', desc: '' },
            { emoji: '🚀', label: 'Acelerado', desc: '' },
          ]} />
        </section>
        ...
        <section className="lesson-section">
          <h3>⚠️ 35. Los nombres no sustituyen la revisión</h3>
        ...
        <section className="lesson-section">
          ...
          <CompareCols cols={[
            { emoji: '🔴', title: 'Propuesta A', items: ['Aplicación pequeña → Instancia enorme → Uso CPU: 2%'] },
            { emoji: '🟢', title: 'Propuesta B', items: ['Aplicación pequeña → Instancia adecuada → Monitoreamos → Ajustamos si crece'] },
          ]} />
        ...
        <div className="bridge-callout">
          ...
          <Flow steps={[
            { emoji: '📀', label: 'Qué plantilla usar' },
            { emoji: '⚙️', label: 'Cuánta capacidad necesitamos' },
            { emoji: '🖥️', label: '' },
          ]} />
          <p>Y preguntaría:</p>
