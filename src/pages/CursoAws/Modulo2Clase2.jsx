    ...
    <div style={{ display: 'flex', flexDirection: 'column', paddingBottom: 'var(--space-8)' }}>
      ...
      <div className="lesson-body">
        ...
        <section className="lesson-section">
          ...
          <RoleGrid roles={[
            { emoji: '👩‍💼', label: 'Carolina', desc: 'Gerente' },
            { emoji: '👨‍💻', label: 'Pedro', desc: 'Informática' },
        ...
        <section className="lesson-section">
          ...
          <ConceptBadge variant="danger">🗑️ clientes.xlsx</ConceptBadge>
          <p>Preguntamos:</p>
        ...
        <section className="lesson-section">
          ...
          <p>Ejemplo:</p>
          <RoleGrid roles={[
            { emoji: '👤', label: 'Carolina', desc: '' },
            { emoji: '👤', label: 'Pedro', desc: '' },
            { emoji: '👤', label: 'Camila', desc: '' },
            { emoji: '👤', label: 'Andrés', desc: '' },
            { emoji: '👤', label: 'Daniela', desc: '' },
          ]} />
        </section>
        ...
        <section className="lesson-section">
          ...
          <CompareCols cols={[
            { emoji: '👤', title: 'Identidad', items: ['¿Quién eres?'] },
            { emoji: '🎫', title: 'Permiso', items: ['¿Qué puedes hacer?'] },
          ]} />
        </section>
        ...
        <section className="lesson-section">
          <h3>🗝️ 8. El hotel de las llaves</h3>
        ...
        <section className="lesson-section">
          ...
          <CompareCols cols={[
            { emoji: '👩‍🎨', title: 'Camila — Marketing', items: ['📸 subir imágenes', '👀 ver imágenes', '❌ no necesita eliminar servidores'] },
            { emoji: '👨‍💻', title: 'Pedro — Infraestructura', items: ['🖥️ administrar determinados servidores', '❌ no necesariamente administra facturación'] },
            { emoji: '👨‍💰', title: 'Andrés — Finanzas', items: ['💰 consultar información de costos', '❌ no necesita modificar aplicaciones'] },
          ]} />
        </section>
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[
            ...
            { emoji: '🎫', label: 'Permisos Marketing', caption: '👀 Ver imágenes · ⬆️ Subir imágenes' },
          ]} />
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[
            { emoji: '👥', label: 'DOCENTES' },
            { emoji: '🎫', label: 'Permisos docentes' },
          ]} />
        </section>
        ...
        <section className="lesson-section">
          ...
          <CompareCols cols={[
            { emoji: '👩', title: 'Antes', items: ['Camila → 👥 Marketing'] },
            { emoji: '👩', title: 'Después', items: ['Camila → 👥 Finanzas'] },
          ]} />
        ...
        <section className="lesson-section">
          ...
          <CompareCols cols={[
            { emoji: '👑', title: 'ROOT USER', items: ['Cuenta AWS', 'Acceso extremadamente poderoso'] },
            { emoji: '👤', title: 'IAM USER', items: ['Identidad administrada mediante IAM', 'Permisos definidos'] },
          ]} />
          <Nota><p>No debemos confundirlos.</p></Nota>
        </section>

        <section className="lesson-section">
          <h3>🛡️ 21. Protección adicional</h3>
