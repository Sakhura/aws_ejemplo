    ...
    <div style={{ display: 'flex', flexDirection: 'column', paddingBottom: 'var(--space-8)' }}>
      ...
      <div className="lesson-body">
        ...
        <section className="lesson-section">
          ...
          <RoleGrid roles={[
            { icon: 'user', label: 'Gerente', desc: '' },
            { icon: 'user', label: 'Informático', desc: '' },
            { icon: 'user', label: 'Marketing', desc: '' },
            { icon: 'user', label: 'Finanzas', desc: '' },
            { icon: 'user', label: 'Desarrollo', desc: '' },
          ]} />
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[
            ...
            { icon: 'lock', label: 'IAM', caption: '🪪 ¿Quién eres? · 🎫 ¿Qué puedes hacer?' },
          ]} />
        ...
        <section className="lesson-section">
          ...
          <CompareCols cols={[
            { icon: 'id-card', title: 'Autenticación', items: ['"Sí, esta persona corresponde."'] },
            { icon: 'tag', title: 'Autorización', items: ['Nuestra entrada dice "Galería".', 'No podemos decidir "hoy quiero sentarme en VIP." 😎', 'Determina a qué zona tenemos acceso.'] },
          ]} />
        </section>

        <section className="lesson-section">
          <h3>11. Llevemos esto a AWS</h3>
          <Nota><p>Una persona intenta acceder.</p></Nota>
          <Flow steps={[
            { icon: 'user', label: 'USUARIO' },
            { icon: 'lock', label: 'IAM' },
            { icon: 'id-card', label: 'AUTENTICACIÓN', caption: '¿Quién eres?' },
            { icon: 'tag', label: 'AUTORIZACIÓN', caption: '¿Qué puedes hacer?' },
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[
            { icon: 'user', label: 'CAMILA' },
            { icon: 'lock', label: 'IAM' },
            { icon: 'tag', label: 'PERMISOS', caption: '👀 Ver · ⬆️ Subir · ❌ No administrar servidores' },
          ]} />
        </section>
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[
            ...
            { icon: 'users', label: 'TODOS' },
            { icon: 'crown', label: 'ACCESO A TODO' },
          ]} />
        ...
        <section className="lesson-section">
          ...
          <CompareCols cols={[
            { icon: 'bell', title: 'Sin MFA', items: ['🔑 Contraseña robada', '↓', '🚨 Acceso potencial'] },
            { icon: 'lock', title: 'Con MFA', items: ['🔑 Contraseña + 📱 Segundo factor', '↓', '🔐 Mayor protección'] },
          ]} />
        ...
        <section className="lesson-section">
          <h3>29. IAM no es solamente "poner contraseñas"</h3>
