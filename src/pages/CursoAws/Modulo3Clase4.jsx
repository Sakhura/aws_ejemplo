    ...
    <div style={{ display: 'flex', flexDirection: 'column', paddingBottom: 'var(--space-8)' }}>
      ...
      <div className="lesson-body">
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[{ emoji: '🌎', label: 'Internet' }, { emoji: '🖥️', label: 'EC2' }]} />
        ...
        <section className="lesson-section">
          <h3>🛡️ 4. Aparece el Security Group</h3>
          ...
          <Flow steps={[{ emoji: '🌎', label: 'Tráfico' }, { emoji: '🛡️', label: 'Security Group' }, { emoji: '🖥️', label: 'EC2' }]} />
        </section>

        <section className="lesson-section">
          <h3>📥 5. ¿Qué significa Inbound?</h3>
          <Dialogo>Inbound significa: tráfico que intenta entrar al recurso.</Dialogo>
          <Flow steps={[{ emoji: '👩', label: 'Usuario' }, { emoji: '🌎', label: 'Internet' }, { emoji: '🛡️', label: 'Security Group' }, { emoji: '🖥️', label: 'EC2' }]} />
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[{ emoji: '🖥️', label: 'EC2' }, { emoji: '🛡️', label: 'Security Group' }, { emoji: '🌎', label: 'Internet' }]} />
        ...
        <section className="lesson-section">
          ...
          <RoleGrid roles={[{ emoji: '🚪', label: '22', desc: '' }, { emoji: '🚪', label: '80', desc: '' }, { emoji: '🚪', label: '443', desc: '' }]} />
        </section>
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[{ emoji: '👩', label: 'Administrador' }, { emoji: '🚪', label: 'Puerto 22' }, { emoji: '🖥️', label: 'EC2 Linux' }]} />
        </section>

        <section className="lesson-section">
          <h3>🌐 12. Puerto 80: HTTP</h3>
          <Nota><p>HTTP se utiliza habitualmente para tráfico web sin cifrado TLS.</p></Nota>
          <Flow steps={[{ emoji: '🌎', label: 'Usuario web' }, { emoji: '🚪', label: 'Puerto 80' }, { emoji: '🌐', label: 'Servidor web' }]} />
        </section>

        <section className="lesson-section">
          <h3>🔒 13. Puerto 443: HTTPS</h3>
          <Nota><p>HTTPS se utiliza habitualmente para tráfico web protegido mediante TLS.</p></Nota>
          <Flow steps={[{ emoji: '🌎', label: 'Usuario' }, { emoji: '🚪', label: 'Puerto 443' }, { emoji: '🔒', label: 'Sitio HTTPS' }]} />
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[{ emoji: '👩', label: 'Mi computador', caption: 'IP: X.X.X.X' }, { emoji: '🚪', label: '22' }, { emoji: '🖥️', label: 'EC2' }]} />
        ...
        <section className="lesson-section">
          <h3>⚠️ 19. ¿0.0.0.0/0 es siempre malo?</h3>
        ...
        <section className="lesson-section">
          ...
          <CompareCols cols={[
            { emoji: '🚪', title: 'Puerta del local comercial', items: ['Queremos que entren clientes.', '🌎 acceso amplio puede tener sentido.'] },
            { emoji: '🔐', title: 'Puerta de tu habitación privada', items: ['¿La dejamos abierta para cualquier persona?', 'Probablemente no.'] },
          ]} />
        ...
        <section className="lesson-section">
          <h3>🛡️ 26. Security Groups son stateful</h3>
          <Nota>
        ...
        <section className="lesson-section">
          ...
          <CompareCols cols={[
            { emoji: '👤', title: 'IAM', items: ['¿Qué identidad puede hacer qué?', '¿Quién puede hacer algo?'] },
            { emoji: '🌐', title: 'Security Group', items: ['¿Qué tráfico de red puede entrar o salir?', '¿Qué conexión de red se permite?'] },
          ]} />
          <p>No son lo mismo.</p>
        </section>
        ...
        <section className="lesson-section">
          <h3>🖥️ 31. Caso: servidor web</h3>
          <Nota><p>Tenemos 🖥️ EC2 y queremos publicar una página web HTTP. Usuarios necesitan:</p></Nota>
          <Flow steps={[{ emoji: '🌎', label: 'Internet' }, { emoji: '🚪', label: '80' }, { emoji: '🖥️', label: 'EC2' }]} />
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[{ emoji: '👩', label: 'Administrador' }, { emoji: '🚪', label: '22' }, { emoji: '🖥️', label: 'EC2' }]} />
          <p>Pero no necesitamos que todos los visitantes web utilicen SSH. Por eso:</p>
          <CompareCols cols={[
            { emoji: '🌎', title: 'HTTP · 80', items: ['público'] },
            { emoji: '📍', title: 'SSH · 22', items: ['restringido'] },
          ]} />
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[
            { emoji: '🖥️', label: 'EC2' },
            { emoji: '📋', label: 'Instances' },
            { emoji: '🎯', label: 'Seleccionar instancia' },
            { emoji: '🛡️', label: 'Security' },
            { emoji: '🔐', label: 'Security Groups' },
          ]} />
        ...
        <section className="lesson-section">
          <h3>✏️ 39. Editar Inbound Rules</h3>
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[{ emoji: '🛡️', label: 'Red permite tráfico' }, { emoji: '🌐', label: 'Servicio está funcionando' }, { emoji: '✅', label: 'Posible respuesta' }]} />
        ...
        <section className="lesson-section">
          <h3>🕵️ 56. Reto: encuentra el error</h3>
        ...
        <div className="bridge-callout">
          ...
          <Flow steps={[{ emoji: '🌎', label: 'Usuario' }, { emoji: '🛡️', label: 'Security Group' }, { emoji: '🖥️', label: 'EC2' }, { n: '?', label: '💾 ???' }]} />
