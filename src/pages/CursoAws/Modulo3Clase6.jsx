    ...
    <div style={{ display: 'flex', flexDirection: 'column', paddingBottom: 'var(--space-8)' }}>
      ...
      <div className="lesson-body">
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[{ emoji: '🌎', label: 'Usuario' }, { emoji: '🛡️', label: 'Security Group' }, { emoji: '🖥️', label: 'EC2' }, { emoji: '💾', label: 'EBS' }]} />
        ...
        <section className="lesson-section">
          <h3>🖥️ 4. Nuestra instancia cambia de estado</h3>
          ...
          <RoleGrid roles={[
            { emoji: '⏳', label: 'Pending', desc: '' },
            { emoji: '🟢', label: 'Running', desc: '' },
            { emoji: '🟠', label: 'Stopping', desc: '' },
            { emoji: '🔴', label: 'Stopped', desc: '' },
            { emoji: '⚫', label: 'Shutting-down', desc: '' },
            { emoji: '❌', label: 'Terminated', desc: '' },
          ]} />
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[{ emoji: '🚀', label: 'Launch' }, { emoji: '⏳', label: 'Pending' }]} />
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[{ emoji: '🟢', label: 'Running' }, { emoji: '🟠', label: 'Stopping' }]} />
          <p>Es otro estado transitorio.</p>
        </section>

        <section className="lesson-section">
          <h3>🔴 10. Stopped</h3>
          <Flow steps={[{ emoji: '🟢', label: 'Running' }, { emoji: '🟠', label: 'Stopping' }, { emoji: '🔴', label: 'Stopped' }]} />
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[{ emoji: '🔴', label: 'EC2 Stopped' }, { emoji: '💾', label: 'EBS puede seguir existiendo' }]} />
        </section>
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[{ emoji: '🔴', label: 'Stopped' }, { emoji: '▶️', label: 'Start' }, { emoji: '⏳', label: 'Pending' }, { emoji: '🟢', label: 'Running' }]} />
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[{ emoji: '🖥️', label: 'EC2' }, { emoji: '🗑️', label: 'Terminate' }, { emoji: '⚫', label: 'Shutting-down' }]} />
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[{ emoji: '⚫', label: 'Shutting-down' }, { emoji: '❌', label: 'Terminated' }]} />
        ...
        <section className="lesson-section">
          <h3>☁️ 21. Aparece Amazon CloudWatch</h3>
        ...
        <section className="lesson-section">
          <h3>🖥️ 22. EC2 + CloudWatch</h3>
          <Flow steps={[{ emoji: '🖥️', label: 'EC2', caption: 'genera métricas' }, { emoji: '📊', label: 'CloudWatch' }, { emoji: '👩', label: 'Nosotros observamos' }]} />
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[{ emoji: '⚙️', label: 'Elegimos capacidad' }, { emoji: '📊', label: 'Monitoreamos' }, { emoji: '🔎', label: 'Analizamos' }, { emoji: '🎯', label: 'Ajustamos' }]} />
        </section>

        <section className="lesson-section">
          <h3>💰 29. Monitoreo y costos se conectan</h3>
          <CompareCols cols={[
            { emoji: '🖥️', title: 'Servidor A', items: ['💰 costoso', '📊 CPU promedio muy baja'] },
            { emoji: '🖥️', title: 'Servidor B', items: ['💰 menor costo', '📊 capacidad suficiente'] },
          ]} />
        ...
        <section className="lesson-section">
          ...
          <ConceptBadge>☁️ AWS + 🖥️ Sistema operativo + ⚙️ Aplicación</ConceptBadge>
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[{ emoji: '🖥️', label: 'EC2' }, { emoji: '📋', label: 'Instances' }, { emoji: '🎯', label: 'Seleccionar instancia' }, { emoji: '📊', label: 'Monitoring' }]} />
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[{ emoji: '📊', label: 'CPU' }, { label: 'CPU > determinado nivel' }, { emoji: '🚨', label: 'Alarma' }]} />
        </section>
        ...
        <section className="lesson-section">
          <h3>⚠️ 38. Una alarma no significa automáticamente un problema</h3>
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[{ emoji: '🖥️', label: 'EC2' }, { emoji: '💾', label: 'EBS' }, { emoji: '📸', label: 'Snapshot' }, { emoji: '🌐', label: 'Red' }]} />
          <p>Por eso debemos pensar en el conjunto de recursos, no solamente en la instancia.</p>
        </section>

        <section className="lesson-section">
          <h3>🍽️ 41. Analogía del restaurante</h3>
        ...
        <section className="lesson-section">
          ...
          <RoleGrid roles={[
            { emoji: '🟢', label: 'On-Demand', desc: 'Flexibilidad' },
            { emoji: '🔵', label: 'Savings Plans', desc: 'Compromiso de uso' },
            { emoji: '🟠', label: 'Spot', desc: 'Ahorro + posible interrupción' },
          ]} />
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[{ emoji: '💰', label: 'Presupuesto' }, { emoji: '📊', label: 'Consumo' }, { emoji: '🚨', label: 'Alerta' }]} />
        </section>
        ...
        <section className="lesson-section">
          <h3>⚠️ 51. Una alerta no detiene automáticamente todo</h3>
        ...
        <section className="lesson-section">
          <h3>🏷️ 54. Aquí los tags empiezan a tener sentido</h3>
        ...
        <section className="lesson-section">
          <h3>🕵️ 59. Caso: el servidor fantasma</h3>
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[{ emoji: '🔎', label: 'Identificar' }, { emoji: '📊', label: 'Analizar' }, { emoji: '🧠', label: 'Decidir' }, { emoji: '🛠️', label: 'Actuar' }, { emoji: '✅', label: 'Verificar' }]} />
        ...
        <section className="lesson-section">
          ...
          <CompareCols cols={[
            { emoji: '🖥️', title: 'Servidor A', items: ['Running', 'CPU: 70%', 'Usuarios activos'] },
            { emoji: '🖥️', title: 'Servidor B', items: ['Running', 'CPU: 0%', 'Sin propietario conocido'] },
          ]} />
        ...
        <section className="lesson-section">
          ...
          <ConceptBadge>⚙️ Rendimiento — 🎯 EQUILIBRIO — 💰 Costo</ConceptBadge>
        ...
        <section className="lesson-section">
          ...
          <RoleGrid roles={[
            { emoji: '🛡️', label: 'SG', desc: 'Acceso' },
            { emoji: '💾', label: 'EBS', desc: 'Datos' },
            { emoji: '📊', label: 'CloudWatch', desc: 'Comportamiento' },
          ]} />
        ...
        <div className="bridge-callout">
          <div className="lesson-eyebrow">🔗 Puente hacia la Clase 7</div>
          <Nota><p>Cerraría mostrando:</p></Nota>
          <Flow steps={[
            { emoji: '📀', label: 'AMI' },
            { emoji: '⚙️', label: 'Instance Type' },
            { emoji: '🔐', label: 'Security Group' },
            { emoji: '💾', label: 'EBS' },
            { emoji: '📊', label: 'CloudWatch' },
            { n: '?', label: '¿?' },
          ]} />
