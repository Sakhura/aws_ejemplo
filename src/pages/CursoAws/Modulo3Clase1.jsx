  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', paddingBottom: 'var(--space-8)' }}>
      ...
      <div className="lesson-body">
        ...
        <section className="lesson-section">
          <h3>🖥️ 3. Primera posibilidad: comprar un servidor</h3>
          <Flow steps={[
            { emoji: '🏢', label: 'Empresa' },
            { emoji: '🖥️', label: 'Servidor físico' },
          ]} />
        ...
        <section className="lesson-section">
          ...
          <CapacityRow label="Capacidad" icons="████████████████████ 100%" />
          <CapacityRow label="Uso real" icons="██░░░░░░░░░░░░░░░░░░ 10%" />
        ...
        <section className="lesson-section">
          ...
          <CompareCols cols={[
            { emoji: '💻', title: 'COMPUTADOR', items: ['🧠 Procesador', '🧮 Memoria RAM', '💾 Almacenamiento', '🪟 Sistema operativo', '🌐 Red'] },
            { emoji: '🖥️', title: 'EC2', items: ['🧠 CPU virtual', '🧮 Memoria', '💾 Almacenamiento', '🐧/🪟 Sistema operativo', '🌐 Conectividad'] },
          ]} />
        ...
        <section className="lesson-section">
          <h3>🖥️ 13. ¿Qué es una instancia?</h3>
          ...
          <RoleGrid roles={[
            { emoji: '🖥️', label: 'Instancia 1', desc: '' },
            { emoji: '🖥️', label: 'Instancia 2', desc: '' },
            { emoji: '🖥️', label: 'Instancia 3', desc: '' },
          ]} />
        </section>
        ...
        <section className="lesson-section">
          ...
          <CompareCols cols={[
            { emoji: '☁️', title: 'Amazon EC2', items: ['Es el servicio.'] },
            { emoji: '🖥️', title: 'Instancia EC2', items: ['Es uno de los servidores virtuales que ejecutamos mediante ese servicio.'] },
          ]} />
          <p>Analogía:</p>
        ...
        <section className="lesson-section">
          ...
          <RoleGrid roles={[
            { emoji: '💻', label: 'Equipo pequeño', desc: '2 CPU · 4 GB RAM' },
            { emoji: '🖥️', label: 'Equipo mediano', desc: '4 CPU · 16 GB RAM' },
            { emoji: '🚀', label: 'Equipo potente', desc: 'muchos CPU · mucha RAM' },
          ]} />
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[{ emoji: '📀', label: 'AMI' }]} />
          <RoleGrid roles={[
            { emoji: '🖥️', label: 'Instancia A', desc: '' },
            { emoji: '🖥️', label: 'Instancia B', desc: '' },
            { emoji: '🖥️', label: 'Instancia C', desc: '' },
          ]} />
        ...
        <section className="lesson-section">
          <h3>🛍️ 21. Volvamos a CloudShop</h3>
          <CapacityRow label="Semana normal" icons="🖥️" />
          <CapacityRow label="Durante una campaña" icons="🖥️ 🖥️ 🖥️" />
          <CapacityRow label="Después" icons="🖥️" />
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[
            ...
            { emoji: '🧹', label: 'Eliminar cuando ya no sea necesario' },
          ]} />
        ...
        <section className="lesson-section">
          <h3>🗑️ 25. ¿Y terminar una instancia?</h3>
        ...
        <section className="lesson-section">
          ...
          <RoleGrid roles={[
            { emoji: '🖥️', label: 'EC2', desc: '' },
            { emoji: '📦', label: 'S3', desc: '' },
            { emoji: '🗄️', label: 'RDS', desc: '' },
            { emoji: '🔐', label: 'IAM', desc: '' },
        ...
        <section className="lesson-section">
          ...
          <CompareCols cols={[
            { emoji: '🔐', title: 'IAM', items: ['Controla acceso y permisos.'] },
            { emoji: '🖥️', title: 'EC2', items: ['Proporciona capacidad de cómputo.'] },
          ]} />
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[
            { emoji: '☁️', label: 'AWS' },
            { emoji: '🌎', label: 'Región' },
            { emoji: '🏢', label: 'Zona de Disponibilidad' },
            { emoji: '🖥️', label: 'EC2' },
          ]} />
        ...
        <section className="lesson-section">
          ...
          <RoleGrid roles={[
            { emoji: '🟢', label: 'Aplicación pequeña', desc: 'Pocos usuarios.' },
            { emoji: '🟡', label: 'Aplicación mediana', desc: 'Más usuarios y procesos.' },
            { emoji: '🔴', label: 'Aplicación exigente', desc: 'Mucho procesamiento.' },
          ]} />
        ...
        <section className="lesson-section">
          ...
          <RoleGrid roles={[
            { emoji: '🧮', label: 'Cómputo', desc: 'Ejecutar apps' },
            { emoji: '📀', label: 'AMI', desc: 'Plantilla → Instancia' },
            { emoji: '⚙️', label: 'Capacidad', desc: 'CPU + memoria' },
          ]} />
          <Flow steps={[
            { emoji: '🖥️', label: 'Instancia' },
          ]} />
          <RoleGrid roles={[
            { emoji: '🌎', label: 'Región', desc: '' },
            { emoji: '💰', label: 'Costos', desc: '' },
          ]} />
        </section>
        ...
        <div className="bridge-callout">
          ...
          <RoleGrid roles={[
            { emoji: '🖥️', label: 'PEQUEÑO', desc: '2 vCPU · 2 GB RAM' },
            { emoji: '🖥️', label: 'MEDIANO', desc: '4 vCPU · 16 GB RAM' },
            { emoji: '🖥️', label: 'GRANDE', desc: 'muchos vCPU · mucha RAM' },
          ]} />
          <p>Y preguntaría:</p>
