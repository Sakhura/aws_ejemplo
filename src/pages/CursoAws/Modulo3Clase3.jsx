    ...
    <div style={{ display: 'flex', flexDirection: 'column', paddingBottom: 'var(--space-8)' }}>
      ...
      <div className="lesson-body">
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[
            { emoji: '📀', label: 'AMI', caption: '¿Qué plantilla?' },
            { emoji: '⚙️', label: 'Instance Type', caption: '¿Qué capacidad?' },
        ...
        <section className="lesson-section">
          <h3>🗺️ 3. Nuestro mapa del laboratorio</h3>
          <Nota><p>Escribiría este flujo en la pizarra:</p></Nota>
          <Flow steps={[
            { emoji: '☁️', label: 'AWS' },
            { emoji: '🌎', label: 'Región' },
            { emoji: '🖥️', label: 'EC2' },
            { emoji: '🚀', label: 'Launch Instance' },
            { emoji: '🏷️', label: 'Nombre' },
            { emoji: '📀', label: 'AMI' },
            { emoji: '⚙️', label: 'Tipo de instancia' },
            { emoji: '🔑', label: 'Key Pair' },
            { emoji: '🌐', label: 'Red' },
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[{ emoji: '☁️', label: 'AWS' }, { emoji: '🌎', label: 'Región seleccionada' }, { emoji: '🖥️', label: 'EC2' }]} />
        </section>
        ...
        <section className="lesson-section">
          <h3>🏷️ 11. Paso 4: nombre de la instancia</h3>
        ...
        <section className="lesson-section">
          <h3>🏷️ 13. ¿Qué son los tags?</h3>
          <Nota><p>AWS permite utilizar etiquetas o tags para organizar recursos.</p></Nota>
          <ConceptBadge>🖥️ EC2 — Curso = AWSDesdeCero</ConceptBadge>
        ...
        <section className="lesson-section">
          <h3>🛡️ 17. ¿Quién publicó la imagen?</h3>
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[
            { emoji: '🏷️', label: 'Nombre', caption: 'ec2-clase3' },
            { emoji: '📀', label: 'AMI', caption: 'Linux apropiado' },
            { emoji: '🖥️', label: 'Nuestro futuro servidor' },
          ]} />
          <p>Pero todavía falta: ¿cuánta capacidad tendrá?</p>
        </section>

        <section className="lesson-section">
          <h3>⚙️ 19. Paso 6: Instance Type</h3>
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[{ emoji: '🔓', label: 'Clave pública' }, { emoji: '🔐', label: 'Clave privada' }]} />
        </section>

        <section className="lesson-section">
          <h3>🏠 24. Analogía de cerradura y llave</h3>
          <CompareCols cols={[
            { emoji: '🖥️', title: 'Instancia', items: ['🔓 información pública'] },
            { emoji: '👩', title: 'Usuario', items: ['🔐 clave privada'] },
          ]} />
        ...
        <section className="lesson-section">
          <h3>🏘️ 29. Analogía de la ciudad</h3>
          <Flow steps={[
            { emoji: '🌎', label: 'AWS' },
            { emoji: '🏙️', label: 'VPC' },
            { emoji: '🏘️', label: 'Subnet' },
            { emoji: '🏠', label: 'EC2' },
          ]} />
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[
            ...
            { emoji: '🌐', label: 'IP pública' },
            { emoji: '🔐', label: 'Seguridad' },
            { emoji: '🖥️', label: 'EC2' },
            { emoji: '🏠', label: 'IP privada' },
          ]} />
        </section>
        ...
        <section className="lesson-section">
          ...
          <RoleGrid roles={[
            { emoji: '🚪', label: 'Puerto 22', desc: 'SSH' },
            { emoji: '🚪', label: 'Puerto 80', desc: 'HTTP' },
            { emoji: '🚪', label: 'Puerto 443', desc: 'HTTPS' },
          ]} />
          <p>El Security Group decide qué tráfico está permitido.</p>
        </section>

        <section className="lesson-section">
          <h3>⚠️ 34. Aquí no hacemos clic alegremente</h3>
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[{ emoji: '🌎', label: 'Región' }, { emoji: '🏢', label: 'Availability Zone' }, { emoji: '🖥️', label: 'EC2' }]} />
        ...
        <section className="lesson-section">
          ...
          <RoleGrid roles={[{ emoji: '🌐', label: 'Public IP', desc: '' }, { emoji: '🏠', label: 'Private IP', desc: '' }]} />
        </section>
        ...
        <section className="lesson-section">
          ...
          <CompareCols cols={[
            { emoji: '🚗', title: 'Running', items: ['Motor encendido.'] },
            { emoji: '🚙', title: 'Stopped', items: ['Motor apagado.'] },
          ]} />
        ...
        <section className="lesson-section">
          <h3>🗑️ 59. Terminate Instance</h3>
          <Dialogo>Terminate significa terminar la instancia.</Dialogo>
          <Flow steps={[{ emoji: '🟢', label: 'Running' }, { emoji: '🗑️', label: 'Terminate' }, { emoji: '⚫', label: 'Shutting-down' }, { emoji: '❌', label: 'Terminated' }]} />
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[{ emoji: '🚀', label: 'CREAR' }, { emoji: '🧪', label: 'PROBAR' }, { emoji: '🔍', label: 'VERIFICAR' }, { emoji: '🧹', label: 'LIMPIAR' }]} />
        ...
        <div className="bridge-callout">
          ...
          <Flow steps={[{ emoji: '🌎', label: 'Internet' }, { n: '?', label: '???' }, { emoji: '🖥️', label: 'EC2' }]} />
          ...
          <Flow steps={[{ emoji: '🌎', label: 'Internet' }, { emoji: '🛡️', label: 'SECURITY GROUP' }, { emoji: '🖥️', label: 'EC2' }]} />
