...
import {
  Icon, Nota, Dialogo, ConceptBadge, RoleGrid, Flow, InfoBox, CompareCols, Reveal, Quiz,
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', paddingBottom: 'var(--space-8)' }}>
      ...
      <div className="lesson-body">
        ...
        <section className="lesson-section">
          <h3>6. ¿Y si no quiero guardar el archivo en mi computador?</h3>
          ...
          <p>Conceptualmente:</p>
          <Flow steps={[
            { icon: 'server', label: 'MI COMPUTADOR' },
            { icon: 'radio', label: 'Internet' },
            { icon: 'cloud', label: 'CLOUD' },
            { icon: 'package', label: 'ALMACENAMIENTO', caption: 'foto.jpg · contrato.pdf · video.mp4' },
          ]} />
        </section>
        ...
        <section className="lesson-section">
          <h3>10. Aparece la base de datos</h3>
          <Nota>
        ...
        <section className="lesson-section">
          ...
          <Flow steps={[
            { icon: 'package', label: 'Antes', caption: 'Mouse · Stock: 30' },
            { emoji: '🛒', label: 'Compra 2' },
            { icon: 'package', label: 'Después', caption: 'Mouse · Stock: 28' },
          ]} />
        ...
        <section className="lesson-section">
          ...
          <CompareCols cols={[
            { icon: 'package', title: 'Archivos', items: ['notebook.jpg', 'mouse.jpg', 'teclado.jpg'] },
            { icon: 'database', title: 'Base de datos', items: ['Notebook', '$600.000', 'Stock: 5'] },
          ]} />
        ...
        <section className="lesson-section">
          ...
          <CompareCols cols={[
            { icon: 'package', title: 'Almacenamiento', items: ['Quiero guardar algo.'] },
            { icon: 'database', title: 'Base de datos', items: ['Quiero guardar información organizada y trabajar con ella.'] },
          ]} />
        ...
        <section className="lesson-section">
          ...
          <CompareCols cols={[
            { icon: 'package', title: 'Material de clases → Almacenamiento', items: ['📄 PDF', '🎬 videos', '📸 imágenes', '📊 presentaciones'] },
            { icon: 'database', title: 'Información académica → Base de datos', items: ['👩‍🎓 estudiantes', '👨‍🏫 docentes', '📚 asignaturas', '📝 notas', '📅 asistencia'] },
          ]} />
        </section>
        ...
        <section className="lesson-section">
          <h3>19. Preparándonos para AWS</h3>
          ...
          <ConceptBadge>Amazon RDS — servicio administrado de bases de datos relacionales</ConceptBadge>
          <Nota>
        ...
        <section className="lesson-section">
          <h3>20. Una precisión importante</h3>
        ...
        <section className="lesson-section">
          ...
          <CompareCols cols={[
            { icon: 'database', title: '🐶 Firulais → Base de datos', items: ['Nombre', 'Edad', 'Propietario', 'Historial'] },
            { icon: 'package', title: '🐶 Firulais → Almacenamiento', items: ['foto1.jpg', 'foto2.jpg', 'examen.pdf'] },
          ]} />
